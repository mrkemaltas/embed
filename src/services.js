...
export default {
    ...
    slideshare: {
        regex: /https?:\/\/www.slideshare.net\/slideshow\/embed_code\/key\/(.*)/,
        embedUrl: 'https://www.slideshare.net/slideshow/embed_code/key/<%= remote_id %>',
        html: '<iframe width="600" height="400" style="margin: 0 auto;" frameborder="0" scrolling="no" allowtransparency="true"></iframe>',
        height: 485,
        width: 595,
    },
    slideshare: {
